  ...
  return (
    <div className="space-y-6">
      ...
      <form action={handleSubmit} className="rounded-2xl border border-kastros-sand bg-white p-6 shadow-sm">
        <h2 className="font-display text-lg font-semibold text-kastros-forest">Your details</h2>
        <p className="mt-1 text-sm text-kastros-sage">PDF or Word résumé required (max 5MB).</p>

        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <label className="text-sm sm:col-span-2">
            <span className="text-kastros-sage">Full name</span>
            <input name="fullName" required autoComplete="name" className="mt-1 w-full rounded-xl border border-kastros-sand px-3 py-2 text-sm" />
          </label>
          <label className="text-sm">
            <span className="text-kastros-sage">Email</span>
            <input name="email" type="email" required autoComplete="email" className="mt-1 w-full rounded-xl border border-kastros-sand px-3 py-2 text-sm" />
          </label>
          <label className="text-sm">
            <span className="text-kastros-sage">Phone</span>
            <input name="phone" type="tel" required autoComplete="tel" className="mt-1 w-full rounded-xl border border-kastros-sand px-3 py-2 text-sm" />
          </label>
          <label className="text-sm sm:col-span-2">
          ...
          <label className="text-sm sm:col-span-2">
            <span className="text-kastros-sage">CV / résumé</span>
            <input name="cv" type="file" required accept=".pdf,.doc,.docx,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" className="mt-1 w-full text-sm file:mr-3 file:rounded-lg file:border-0 file:bg-kastros-cream file:px-3 file:py-2 file:text-sm file:font-semibold file:text-kastros-forest" />
          </label>
        </div>
